export default {
    ...
    canvas: {
        ...
        toolbar: {
            select: "选择", pan: "移动", text: "文本", image: "图片", video: "视频", audio: "音频", config: "生成配置", extensions: "扩展节点", upload: "上传资产", appearance: "画布外观", clear: "清空画布",
        ...
        createMenu: {
            fromNode: "引用该节点生成", fromSelectedNodes: "引用选中节点生成", close: "关闭", text: "文本生成", textDescription: "脚本、广告词、品牌文案", image: "图片生成", video: "视频生成", audio: "音频参考", config: "配置节点", configDescription: "模型、尺寸、数量和输入顺序", select: "选择节点",
        },
        connection: { input: "输入连接点，单击创建节点或拖动连线", output: "输出连接点，单击创建节点或拖动连线", selectedInput: "从新节点连接到选中节点", selectedOutput: "从选中节点连接到新节点" },
        selectionLayout: { left: "左对齐", centerHorizontal: "水平居中", right: "右对齐", top: "顶对齐", centerVertical: "垂直居中", bottom: "底对齐", distributeHorizontal: "水平等距", distributeVertical: "垂直等距", arrangeHorizontal: "横向排列", arrangeVertical: "纵向排列", arrangeGrid: "宫格排列", organizeConnections: "按连线整理" },
        node: {
            node: "节点",
    ...
    config: {
        ...
        proxy: {
            title: "本地代理",
            description: "开启后，模型列表、生图、生视频、文本、音频和 WebDAV 请求会先经本机代理转发，用于绕过浏览器跨域限制。",
            startHint: "先在终端运行下面的命令，并在使用画布期间保持运行：",
            address: "代理地址",
            addressDescription: "填写命令启动后打印的地址。",
            channelHint: "渠道和 WebDAV 仍填写真实地址，不要填写代理地址；关闭开关即可恢复直连。",
            test: "测试连接",
            available: "本地代理连接正常（{{proxy}}）",
            missingUrl: "请先填写本地代理地址。",
            unreachable: "无法连接本地代理，请确认命令已启动且地址正确。",
        },
        localStorage: {
        ...
        importedChannelCreated: "已新增渠道：{{name}}",
        importedChannelUpdated: "已更新渠道：{{name}}",
        importedChannelBaseUrlRequired: "缺少 Base URL，未修改配置",
        importedChannelBaseUrlInvalid: "Base URL 格式不正确，未修改配置",
