export default {
    ...
    canvas: {
        ...
        toolbar: {
            select: "Select", pan: "Move", text: "Text", image: "Image", video: "Video", audio: "Audio", config: "Generation config", extensions: "Extension nodes", upload: "Upload assets", appearance: "Canvas appearance", clear: "Clear canvas",
        ...
        createMenu: {
            fromNode: "Generate from this node", fromSelectedNodes: "Generate from selected nodes", close: "Close", text: "Generate text", textDescription: "Scripts, ad copy, and brand content", image: "Generate image", video: "Generate video", audio: "Audio reference", config: "Configuration node", configDescription: "Model, size, count, and input order", select: "Select a node",
        },
        connection: { input: "Input connection point: click to create a node or drag to connect", output: "Output connection point: click to create a node or drag to connect", selectedInput: "Connect a new node to the selected nodes", selectedOutput: "Connect the selected nodes to a new node" },
        selectionLayout: { left: "Align left", centerHorizontal: "Align center horizontally", right: "Align right", top: "Align top", centerVertical: "Align center vertically", bottom: "Align bottom", distributeHorizontal: "Distribute horizontally", distributeVertical: "Distribute vertically", arrangeHorizontal: "Arrange horizontally", arrangeVertical: "Arrange vertically", arrangeGrid: "Arrange as grid", organizeConnections: "Organize by connections" },
        node: {
            node: "Node",
    ...
    config: {
        ...
        proxy: {
            title: "Local proxy",
            description: "Forward model, image, video, text, audio, and WebDAV requests through a local proxy to avoid browser CORS errors.",
            startHint: "Run this command in a terminal first and keep it running while you use the canvas:",
            address: "Proxy address",
            addressDescription: "Use the address printed by the command.",
            channelHint: "Keep real provider and WebDAV URLs here, not the proxy URL. Turn the switch off to restore direct requests.",
            test: "Test connection",
            available: "Local proxy is reachable ({{proxy}})",
            missingUrl: "Enter the local proxy address first.",
            unreachable: "Local proxy is unreachable. Make sure it is running and the address is correct.",
        },
        localStorage: {
        ...
        importedChannelCreated: "Channel added: {{name}}",
        importedChannelUpdated: "Channel updated: {{name}}",
        importedChannelBaseUrlRequired: "Base URL is missing; configuration was not changed",
        importedChannelBaseUrlInvalid: "Base URL is invalid; configuration was not changed",
