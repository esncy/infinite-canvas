export default {
    ...
    canvas: {
        ...
        connection: { input: "Input connection point: click to create a node or drag to connect", output: "Output connection point: click to create a node or drag to connect" },
